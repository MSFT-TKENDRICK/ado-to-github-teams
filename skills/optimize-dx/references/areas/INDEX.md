...
| 3   | `local-environment-and-onboarding` | [local-environment-and-onboarding.md](local-environment-and-onboarding.md) | Fresh-clone path to a passing local change: prereqs, package manager, install, build, sandbox. |
