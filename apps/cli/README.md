# `@ado-to-github-teams/cli`

This package currently provides the installable CLI shell and its help/version smoke paths.
Migration commands and adapters are intentionally delivered in later layers.

The primary executable is `a2g`; `ado-to-github-teams` remains a compatibility alias.
