...
const developerExperienceSkill = defineSkill({
  name: 'optimize-dx',
  description:
    'Critique the full contributor-to-consumer CLI journey against nine pain categories, execute the affected command or artifact contract, implement one bounded surface change, refresh documentation, and stop truthfully. Numeric measurements are supporting evidence only.',
