...
const developerExperienceSkill = defineSkill({
  name: 'optimize-devx',
  description:
    'Measure real developer-experience quantities in this repository, defend them against documentation drift, and stop truthfully when the numbers stop moving.',
