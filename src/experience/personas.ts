...
export const PERSONA_DEFINITIONS = [
  ...
  },
  {
    ...
    // repository evidence — 37 root scripts behind a two-command on-ramp, lefthook pinned and
    ...
    sensitivities: {
      ...
      // Highest lever, and I am willing to defend it: 37 root scripts remain a real, measured
