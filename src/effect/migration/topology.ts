...
import {TeamTopologyConfigSchema, topologyValidationMessage} from './topology-schema.js'

export {TeamTopologyConfigSchema, topologyValidationMessage} from './topology-schema.js'
