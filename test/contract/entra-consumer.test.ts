...
function runEntra<A>(
  ...
  // assertions below would never see `_tag`/`status`. Run to an `Exit` and
  // re-throw the actual failure value so the Promise-based assertions see
  // the real, tagged domain error.
